...
public enum ErrorMessageConstants {
    ...
    // === 궁합 해설(CompatibilityNarrative) 예외 메시지 ===
    COMPATIBILITY_NARRATIVE_EMPTY_RESPONSE("OPENAI_INVALID_RESPONSE", "궁합 해설 응답이 비어있습니다"),
    COMPATIBILITY_NARRATIVE_BLANK_FIELD("OPENAI_INVALID_RESPONSE", "궁합 해설 응답에 비어있는 텍스트 필드가 있습니다"),
    COMPATIBILITY_NARRATIVE_MISSING_INTERVIEW_QUESTIONS("OPENAI_INVALID_RESPONSE", "예상 면접 질문이 최소 1개 이상 필요합니다"),
    COMPATIBILITY_NARRATIVE_INVALID_INTERVIEW_ITEM("OPENAI_INVALID_RESPONSE", "예상 면접 질문 항목에 빈 값이 포함되어 있습니다"),
    COMPATIBILITY_NARRATIVE_INVALID_MONTHLY_ADVICES_COUNT("OPENAI_INVALID_RESPONSE", "월별 조언은 정확히 5개여야 합니다"),
    COMPATIBILITY_NARRATIVE_INVALID_MONTHLY_ADVICES_MONTHS("OPENAI_INVALID_RESPONSE", "월별 조언의 월 값이 요청한 대상 월과 일치하지 않습니다"),
    COMPATIBILITY_NARRATIVE_MISSING_CAUTIONS("OPENAI_INVALID_RESPONSE", "주의사항이 최소 1개 이상 필요합니다"),
    ...
    FEEDBACK_NOT_ALLOWED("FEEDBACK_NOT_ALLOWED", "관운 분석은 피드백 대상이 아닙니다."),
