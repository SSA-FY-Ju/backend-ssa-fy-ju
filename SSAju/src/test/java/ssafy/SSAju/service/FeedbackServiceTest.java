...
class FeedbackServiceTest {
    ...
    void shouldSaveFeedback_WhenCompatibilityType() {
        var request = new SatisfactionFeedbackRequest(
                1L, AnalysisType.COMPANY_COMPATIBILITY, SatisfactionStatus.SATISFIED, "좋았습니다");
        ...
        var savedFeedback = UserSatisfactionFeedback.builder()
                ...
                .feedbackType(AnalysisType.COMPANY_COMPATIBILITY)
    ...
    void shouldSaveFeedback_WhenConsultationType() {
        var request = new SatisfactionFeedbackRequest(
                1L, AnalysisType.CAREER_CONSULTATION, SatisfactionStatus.DISSATISFIED, null);
    ...
    void shouldThrow_WhenConsultationBelongsToOtherUser() {
        ...
        var request = new SatisfactionFeedbackRequest(
                1L, AnalysisType.CAREER_CONSULTATION, SatisfactionStatus.SATISFIED, null);
    ...
    void shouldThrowFeedbackNotAllowedException_WhenCareerTimingType() {
        var request = new SatisfactionFeedbackRequest(
                1L, AnalysisType.SAJU, SatisfactionStatus.SATISFIED, null);
    ...
    void shouldThrowUserNotFoundException_WhenUserNotFound() {
        var request = new SatisfactionFeedbackRequest(
                1L, AnalysisType.COMPANY_COMPATIBILITY, SatisfactionStatus.SATISFIED, null);
    ...
    void shouldThrowSajuResultNotFoundException_WhenCompatibilityNotFound() {
        var request = new SatisfactionFeedbackRequest(
                999L, AnalysisType.COMPANY_COMPATIBILITY, SatisfactionStatus.SATISFIED, null);
